...
import com.example.runningapp.other.Constance
...
object ServiceModule {
    ...
    @ServiceScoped //only one Instance of the providerClinet in the service
    @Provides
    ...
    fun provideMainActivityPendingIntent(
        ...
        PendingIntent.FLAG_UPDATE_CURRENT //wehener we lauch the intent it will be updated instead of creating again
    )
